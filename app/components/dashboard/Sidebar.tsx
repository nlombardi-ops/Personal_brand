...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="fixed left-0 top-0 bottom-0 z-40 hidden w-60 flex-col bg-stone-100 border-r border-stone-200 md:flex">
      ...
      <header className="fixed inset-x-0 top-0 z-30 flex h-14 items-center justify-between border-b border-stone-200 bg-stone-50 px-4 md:hidden">
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-md text-stone-600 transition-colors hover:text-stone-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-400"
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-stone-200 px-5 py-4">
              ...
              <button
                ...
                className="rounded-md p-1 text-stone-500 transition-colors hover:text-stone-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-400"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
